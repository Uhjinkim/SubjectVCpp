...
void DrawBonobono(HDC hdc, int x, int y, int a, int b, BOOL closeEyes) {
    ...
    for (int i = 0; i < 2; ++i) {
        ...
        int px = x + static_cast<int>(a * 4.0 / 5 * cos(radian));
        int py = y + static_cast<int>(b * 4.0 / 5 * sin(radian));
        if (!closeEyes) {
    ...
    for (int i = 0; i < 2; ++i) {
        ...
        int px = x + static_cast<int>(a * 0.5 * cos(radian));
        int py = y + static_cast<int>(b * 0.5 * sin(radian));
...
void DrawRyan(HDC hdc, int x, int y, int sy, int ey, int a, int b) {
    ...
    for (int i = 0; i < 2; ++i) {
        ...
        int px = x + static_cast<int>(a / 2.0 * cos(radian));
        int py = y + static_cast<int>(b / 2.0 * sin(radian));
